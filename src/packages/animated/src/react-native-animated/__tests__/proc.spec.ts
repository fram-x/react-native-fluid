...
describe("proc", () => {
  it("should call proc", () => {
    ...
    expect((valueToTest as AnimatedNode).evaluate()).toBe(20);
  });

  it("should call nested procs", () => {
    const addNumbers = Animated.proc("", (a, b) => Animated.add(a, b));
    const valueToTest = addNumbers(10, addNumbers(10, 10));
    expect((valueToTest as AnimatedNode).evaluate()).toBe(30);
  });
  ...
  it("should call composite procs", () => {
    ...
    expect((valueToTest as AnimatedNode).evaluate()).toBe(400);
  });
